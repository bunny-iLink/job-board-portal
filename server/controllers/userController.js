...
export async function deleteUserData(req, res) {
  try {
    ...
    console.log(
      `Deleted ${appDeleteResult.deletedCount} applications for user ID: ${userId}`
    );
    ...
    console.log(
      `Deleted ${notificationDeleteResult.deletedCount} notifications for user ID: ${userId}`
    );
...
export async function deleteEmployerData(req, res) {
  try {
    ...
    console.log(
      `Deleted ${jobDeleteResult.deletedCount} job(s) for employer ID: ${employerId}`
    );
