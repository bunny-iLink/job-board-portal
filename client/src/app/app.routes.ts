...
export const routes: Routes = [
    ...
    children: [
      {
        ...
        loadComponent: () =>
          import(
            './components/employer/dashboard/employer-dashboard.component'
      ...
      },
      {
        ...
        loadComponent: () =>
          import(
            './components/employer/employer-profile/employer-profile'
          ).then((m) => m.EmployerProfileComponent),
      },
      {
        path: 'my-listings',
        loadComponent: () =>
          import('./components/employer/my-listings/my-listings').then(
      ...
      },
      {
        path: 'job-details',
        loadComponent: () =>
          import('../app/components/employer/job-details/job-details').then(
...

  {
    path: 'user',
    loadComponent: () =>
      import('./components/user/user-layout/user-layout').then(
    ...
    children: [
      ...
      },
      {
        path: 'profile',
        loadComponent: () =>
          import('./components/user/user-profile/user-profile').then(
      ...
      },
      {
        path: 'jobs',
        loadComponent: () =>
          import('./components/user/search-jobs/search-jobs').then(
      ...
      },
      {
        path: 'applied-jobs',
        loadComponent: () =>
          import('./components/user/applied-jobs/applied-jobs').then(
